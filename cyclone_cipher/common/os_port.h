...
//MemAlloc
#define osAllocMem(size) ks_malloc(size)

//Memfree
#define osFreeMem(size) ks_free(size)
...
//Copy string
#define osStrcpy(s1, s2) myosStrcpy(s1, s2)
#ifndef osStrcpy
   #include <string.h>
...
#define osStrncpy(s1, s2, length) myosStrncpy(s1, s2, length)
#ifndef osStrncpy
   #include <string.h>
...
//Concatenate strings
#define osStrcat(s1, s2) myosStrcat(s1, s2)
#ifndef osStrcat
   #include <string.h>
...
#define osTolower(c) myosTolower((uint8_t) (c))
#ifndef osTolower
   #include <ctype.h>
...
#define osToupper(c) myosToupper((uint8_t) (c))
#ifndef osToupper
   #include <ctype.h>
...
#define osIsupper(c) myosIsupper((uint8_t) (c))
#ifndef osIsupper
   #include <ctype.h>
...
#define osIsdigit(c) myosIsdigit((uint8_t) (c))
#ifndef osIsdigit
   #include <ctype.h>
...
#define osIsspace(c) myosIsspace((uint8_t) (c))
#ifndef osIsspace
   #include <ctype.h>
